...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/junedthemoviesprovider"),
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('HOLLYWOOD', url='https://t.me/junedthemoviesprovider')],
                                            [InlineKeyboardButton('♥️BOLLYWOOD♥️', url='https://t.me/junedthemoviesprovider')],
                                             [InlineKeyboardButton('♥️TOLLYWOOD♥️', url='https://t.me/junedthemoviesprovider'),
                                              InlineKeyboardButton('♥️MOVIE♥️', url='https://t.me/junedthemoviesprovider')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
